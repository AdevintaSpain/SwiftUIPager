Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/AdevintaSpain/SwiftUIPager/"
  s.license      = { :type => "MIT", :file => "LICENSE" }
  s.author             = { "devs iOS" => "gp.es.dev.ios@adevinta.com" }

  s.platforms = { :ios => "12.0", :osx => "10.15", :watchos => "6.0", :tvos => "13.0" }
  s.swift_version = "5.1"

  s.source       = { :git => "https://github.com/AdevintaSpain/SwiftUIPager.git", :tag => "#{s.version}" }
  s.source_files  = "Sources/SwiftUIPager/**/*.swift"

  s.documentation_url = "https://github.com/AdevintaSpain/SwiftUIPager/blob/master/README.md"
